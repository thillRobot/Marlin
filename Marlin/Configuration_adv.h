...
#define MICROSTEP_MODES {16,8,8,16,16,16} // [1,2,4,8,16] // TH changed extruder1 to 2 (1/2 stepping) for E3D 0.9deg/step 'slimline' motor -> this should increase torque
